      ...
      const navTogglerBtn = document.querySelector(".nav-toggler"),
            ...
            function showProjectDetails(projectId) {
              ...
              const projects = {
                ...
                proyecto2: {
                  title: "Aplicación de Gestión de Transporte",
                  thumbnail: "images/proyecto2.jpg",
                  description: `
                    <p>Una aplicación para gestionar itinerarios y rutas de transporte urbano.</p>
                  `,
                  video: "videos/proyecto2.mp4",
                  additionalDescription: `
                    <p>Incluye integración con bases de datos y bots de WhatsApp.</p>
                  `
                },
                proyecto3: {
